           ...
           <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="row my-2">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <a href="{{ route('contents') }}" id="view-all-contents" class="btn btn-primary float-right">View All Added Contents</a>
                        </div>
                    </div>
                    <hr class="mt-0 mb-2">
...
<script>  
    $(document).ready(function() {
        @if(session()->has('contents'))
        @if(count(session()->get('contents')) == 0)
            $('#view-all-contents').hide();
        @endif
        @endif
